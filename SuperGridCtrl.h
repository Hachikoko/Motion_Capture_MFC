...
public:
	...
	enum CONTROLTYPE {edit/*default*/, combobox, datecontrol/*your control*/, button/*your control*/, dropdownlistviewwhatevercontrol/*your control*/};
	...
	void SetNodeNumber(int n) { nodeNumber = n; }
...
private:
	...
	CMap<int,int, COLORREF, COLORREF&> m_mapClf;//colors			//为条目子项准备
